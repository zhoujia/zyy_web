...
<template>
  <section class="master-page-container">
    <div class="master-page-wrap">
      ...
      <div class="master-page-search-content"
           v-if="$slots.searchContent">
        <slot name="searchContent"></slot>
      </div>
      <div class="master-page-content-toolbar"
      ...
      <div class="master-page-padding-content"
           v-if="$slots.paddingContent">
        <slot name="paddingContent"></slot>
      </div>
      <div class="master-page-nopadding-content"
           v-if="$slots.content">
